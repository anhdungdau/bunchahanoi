...
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <table align="center" width="750">
    ...
    <tr>
      ...
      <td><textarea type="textarea" cols="20" rows="5" name="c_address" value="<?php echo $address; ?>" required></textarea></td>
    </tr>
...
<?php
    ...
    $c_image = $_FILES['c_image']['name'];
		...
		$update_c = "UPDATE customers set customer_name='$c_name', customer_email='$c_email', customer_pass='$c_pass', customer_country='$c_country', customer_city='$c_city', customer_contact='$c_contact', customer_image='$c_image', customer_address='$c_address' WHERE customer_id='$customer_id'";
