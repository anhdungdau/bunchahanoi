...
if(isset($_GET['edit_pro'])){
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$row_meat=mysqli_fetch_array($run_meat);
...
<body bgcolor="skyblue">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		echo "<option value='$cat_id'>$cat_title</option>";
			...
			<tr>
				<td align="right"><b>Product meat:</b></td>
				<td>
	...
	while ($row_meats=mysqli_fetch_array($run_meats)){

		$meat_id = $row_meats['meat_id'];
		$meat_title = $row_meats['meat_title'];
...
<?php
	...
	if(isset($_POST['update_product'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "update products set product_cat='$product_cat',product_meat='$product_meat',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$product_image', product_keywords='$product_keywords' where product_id='$update_id'";
